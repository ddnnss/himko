...
function feedback(vars) {
  ...
  var data_params = 'act=' + vars.act + '&' + vars.data;

  var product_name = $('.JsProductName').text();
  if(product_name && product_name != ''){
    data_params += '&product_name=' + product_name;
  }
  data_params += '&url=' + window.location.href;
      ...
      success: function(answer) {
        ...
        if(isset(cfg.notify) && !/none/i.test(cfg.notify)) {
          ...
          if(isset(answer.ok) && answer.ok == 1) {
            yaCounter54989140.reachGoal('yspeh');
            $(vars.form)[0].reset();
          }
      }
  });
